<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="AdminCourseInfo.aspx.cs" Inherits="CRM_WQG_UI.AdminCourseInfo" %>
                    ...
                    <asp:GridView ID="gvUser" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                   <asp:LinkButton ID="editCourse" runat="server" CommandName="EditCourse" CommandArgument='<%#Eval("CourseNum")%>'>编辑</asp:LinkButton>
                                   <asp:LinkButton ID="DeleteUser" runat="server" CommandName="DeleteCourse" CommandArgument='<%#Eval("CourseNum")%>'>删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
