<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateInfo.aspx.cs" Inherits="CRM_WQG_UI.UpdateInfo" %>
          ...
          <div id="form_submit" class="form_submit">
            <div class="fieldset">
             <div class="field-group">
                <label class="required title">我的学号</label>
                <span class="control-group" id="mobile_input">
                <div class="input_add_long_background">
                  <asp:TextBox ID="txtStuId" runat="server" MaxLength="8" 
                        style="background-color:#f9f9f9;border:0 none;color:#4F4F4F;font-size:12px;height:18px;outline:medium none;width: 270px;padding:1px;margin:5px;" ReadOnly="True"></asp:TextBox>
              ...
              <div class="field-group">
               ...
               <div class="field-group">
               <label class="required title">我的姓名</label>
               ...
               <div class="field-group">
               <label class="required title">我的年龄</label>
               ...
               <div class="field-group">
               <label class="required title">我的性别</label>
