<%@ Page Title="" Language="C#" MasterPageFile="~/student.Master" AutoEventWireup="true" CodeBehind="CourseInfo.aspx.cs" Inherits="CRM_WQG_UI.CourseInfo" %>
            ...
            <tr>
                <td colspan="3" style="background-image: url('Images/main_top_bg.gif'); height: 19px;">
                    <asp:Image ID="Image1" runat="server" Height="17px" ImageUrl="Images/main_top_1.gif"
                        Width="21px" />在线选课（课程选中后若要取消请到“已选课程”中取消）</td>
            </tr>
            <tr>
                    ...
                    <asp:GridView ID="gvUser" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                   <asp:LinkButton ID="DeleteUser" runat="server" CommandName="ChooseCourse" CommandArgument='<%#Eval("CourseName")%>'>选择</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                    <br />
                    <asp:Label ID="lblMsg" runat="server" Text="已选择课程：" ForeColor="Black"></asp:Label>
                    &nbsp;<asp:Label ID="lblCourse" runat="server"></asp:Label>
                    <br />
                    <br />
                    &nbsp;<asp:Button ID="btnCommit" runat="server" style=" border:0;" Text="提交" 
                        BackColor="#3399FF" ForeColor="White" Width="70px" 
