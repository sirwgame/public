<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditStudent.aspx.cs" Inherits="CRM_WQG_UI.EditStudent" %>
        ...
        <form runat="server" id="form" action="#" method="post">
          <div id="form_submit" class="form_submit">
            ...
            <div class="field-group">
                <label class="required title">学生编号</label>
             ...
             <div class="field-group">
                ...
                <div class="input_add_long_background">
                  <asp:TextBox ID="txtStuId" runat="server" MaxLength="8" style="background-color:#f9f9f9;border:0 none;color:#4F4F4F;font-size:12px;height:18px;outline:medium none;width: 270px;padding:1px;margin:5px;" ReadOnly="True"></asp:TextBox>
